...
import {newEmptyMailEditorDialog} from "./MailEditorN"
...
export class MailView implements CurrentView {
	...
	_newMail(): Promise<Dialog> {
		return this._getMailboxDetails().then(mailboxDetails => newEmptyMailEditorDialog(mailboxDetails)).then(dialog => dialog.show())
	}
